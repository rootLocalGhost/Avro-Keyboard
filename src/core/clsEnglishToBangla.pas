...
type
  TEnglishToBangla = class
    private
      pEnglishText:      UnicodeString;
      ln:                Integer; // Length of English String
      pos:               Integer; // Position of processing at English String
      RS:                UnicodeString;  // Result String
      AutoCorrect:       Boolean;
      DetermineZWNJ_ZWJ: UnicodeString;

      procedure CutText(const inputEStr: UnicodeString; var outSIgnore: UnicodeString; var outMidMain: UnicodeString; var outEIgnore: UnicodeString);
      function MyConvert(): UnicodeString;
      procedure Dot;
      procedure smallO;
      procedure O;
      procedure h;
      ...
      procedure k;
      procedure g;
      function Cnv(const Compare: UnicodeString; const IfTrue: UnicodeString): Boolean;
      procedure AddRs(const T: UnicodeString);
      procedure AddRsEx(const T: UnicodeString; p: Integer = 0);
      function PrevT: UnicodeString;
      function PrevTEx(const Position: Integer): UnicodeString;
      function NextT: UnicodeString;
      function NextTEx(iLength: Integer; skipstart: Integer = 0): UnicodeString;
      function Vowel(const T: UnicodeString): Boolean;
      function Consonent(const T: UnicodeString): Boolean;
      function Number(const T: UnicodeString): Boolean;
      function Begining: Boolean;
    public
      constructor Create; // Initializer
      function Convert(const EnglishT: UnicodeString): UnicodeString;
      function CorrectCase(const inputT: UnicodeString): UnicodeString;
      // Published
...
procedure TEnglishToBangla.AddRs(const T: UnicodeString);
begin
  RS := RS + T;
  pos := pos + 1;
end;
...
procedure TEnglishToBangla.AddRsEx(const T: UnicodeString; p: Integer);
begin
  RS := RS + T;
  pos := pos + p;
end;
...
function TEnglishToBangla.Cnv(const Compare: UnicodeString; const IfTrue: UnicodeString): Boolean;
var
  i:   Integer;
  tmp: UnicodeString;
begin
...
function TEnglishToBangla.Consonent(const T: UnicodeString): Boolean;
var
  temp: Char;
  myT:  UnicodeString;
begin
...
function TEnglishToBangla.Convert(const EnglishT: UnicodeString): UnicodeString;
var
  EngStr:                                                   UnicodeString;
  Starting_Ignoreable_T, Middle_Main_T, Ending_Ignorable_T: UnicodeString;
  tempStr:                                                  UnicodeString;
  DictItem:                                                 UnicodeString;
begin
...
function TEnglishToBangla.CorrectCase(const inputT: UnicodeString): UnicodeString;
var
  i, l:    Integer;
...
procedure TEnglishToBangla.CutText(const inputEStr: UnicodeString; var outSIgnore, outMidMain, outEIgnore: UnicodeString);
var
  i:                 Integer;
  p, q:              Integer;
  EStrLen:           Integer;
  tStr:              Char;
  reverse_inputEStr: UnicodeString;
  temporaryString:   UnicodeString;
begin
...
function TEnglishToBangla.MyConvert: UnicodeString;
var
  tt:      Char;
...
function TEnglishToBangla.NextT: UnicodeString;
begin
...
function TEnglishToBangla.NextTEx(iLength: Integer; skipstart: Integer): UnicodeString;
begin
  if iLength < 1 then
    iLength := 1;
...
function TEnglishToBangla.PrevT: UnicodeString;
var
  i: Integer;
begin
...
function TEnglishToBangla.PrevTEx(const Position: Integer): UnicodeString;
var
  i: Integer;
begin
  i := pos - Position;
...
function TEnglishToBangla.Vowel(const T: UnicodeString): Boolean;
var
  myT: UnicodeString;
begin
  Result := False;
...
function TEnglishToBangla.Number(const T: UnicodeString): Boolean;
var
  temp: Char;
  myT:  UnicodeString;
begin
